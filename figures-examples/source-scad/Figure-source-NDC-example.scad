...
RaisedFloorTransparency=0.8;
 union(){
    DCfloor(5,5,FloorColor,RaisedFloorTransparency,RaisedFloorHeight);
 }
// per Rack stuff
...
//Device Stuff
//place a device in the rack
    translate(DCFloorOffset1000)
        placeInRack(1,StandardRackUnitWidth,622,RackUnitDepth/1.1,RackUnitColorRed,"Nexus 7010");
        translate(DCFloorOffset2)
        placeInRack(1,StandardRackUnitWidth,622,RackUnitDepth/1.1,RackUnitColorBlue,"Nexus 7010");
    translate(DCFloorOffset0)
        placeInRack(15,StandardRackUnitWidth,170,RackUnitDepth,RackUnitColorGreen,"Klaus-South");
    translate(DCFloorOffset0)
        placeInRack(19,StandardRackUnitWidth,170,RackUnitDepth,RackUnitColorGreen,"Klaus-North");
        color([1,0,0],0.2)translate(DCFloorOffset0+[0,800,0])cube([2400,800,2070]);

    translate(DCFloorOffset0)
        placeInRack(23,StandardRackUnitWidth,1*StandardRackUnitHeight,RackUnitDepth,RackUnitColor,"Shelf");
    translate(DCFloorOffset1000)
        placeInRack(24,StandardRackUnitWidth,1*StandardRackUnitHeight,RackUnitDepth*0.7,RackUnitColorRed,"Cisco Nexus 2248TP");
    translate(DCFloorOffset1000)
        placeInRack(25,StandardRackUnitWidth,1*StandardRackUnitHeight,RackUnitDepth*0.75,RackUnitColorRed,"Cisco Nexus 2232PP");
    translate(DCFloorOffset1000)
        placeInRack(26,StandardRackUnitWidth,1*StandardRackUnitHeight,RackUnitDepth*0.75,RackUnitColorRed,"Cisco Nexus 2232PP");
    translate(DCFloorOffset1000)
        placeInRack(27,StandardRackUnitWidth,1*StandardRackUnitHeight,RackUnitDepth*0.7,RackUnitColorRed,"Cisco Nexus 2248TP");
    translate(DCFloorOffset1000)
        placeInRack(28,StandardRackUnitWidth,1*StandardRackUnitHeight,RackUnitDepth*0.75,RackUnitColorRed,"Cisco Nexus 2232PP");
    translate(DCFloorOffset1000)
        placeInRack(29,StandardRackUnitWidth,1*StandardRackUnitHeight,RackUnitDepth*0.7,RackUnitColorRed,"Cisco Nexus 2248TP");
    translate(DCFloorOffset1000)
        placeInRack(39,StandardRackUnitWidth,2*StandardRackUnitHeight,RackUnitDepth*0.8,RackUnitColorRed,"Cisco Nexus 5596UP");
    translate(DCFloorOffset1)
        placeInRack(3,StandardRackUnitWidth,2*StandardRackUnitHeight,RackUnitDepth,RackUnitColorGreen,"TS-001");
    translate(DCFloorOffset1)
        placeInRack(5,StandardRackUnitWidth,2*StandardRackUnitHeight,RackUnitDepth,RackUnitColorGreen,"TS-999");
    translate(DCFloorOffset1001)
        placeInRack(7,StandardRackUnitWidth,2*StandardRackUnitHeight,RackUnitDepth,RackUnitColor,"TS-020");
    translate(DCFloorOffset1001)
        placeInRack(9,StandardRackUnitWidth,2*StandardRackUnitHeight,RackUnitDepth,RackUnitColor,"TS-030");
   translate(DCFloorOffset1001)
        placeInRack(11,StandardRackUnitWidth,1*StandardRackUnitHeight,RackUnitDepth/3,RackUnitColorRed,"IBM G8264");
    translate(DCFloorOffset1001)
        placeInRack(12,StandardRackUnitWidth,1*StandardRackUnitHeight,RackUnitDepth/3,RackUnitColorRed,"IBM G8264"); 
    translate(DCFloorOffset1)
        placeInRack(23,StandardRackUnitWidth,1*StandardRackUnitHeight,RackUnitDepth,RackUnitColorGreen,"KVM Console");
    translate(DCFloorOffset1001)
        placeInRack(28,StandardRackUnitWidth,2*StandardRackUnitHeight,RackUnitDepth/2,RackUnitColorRed,"Juniper SRX 650");
    translate(DCFloorOffset1001)
        placeInRack(30,StandardRackUnitWidth,2*StandardRackUnitHeight,RackUnitDepth,RackUnitColor,"EX4500");
    translate(DCFloorOffset1001)      
        placeInRack(34,StandardRackUnitWidth,2*StandardRackUnitHeight,RackUnitDepth/2,RackUnitColorRed,"Juniper SRX 650");
    translate(DCFloorOffset1001)
        placeInRack(36,StandardRackUnitWidth,3*StandardRackUnitHeight,RackUnitDepth*0.8,RackUnitColorRed,"Cisco VPN Router");    
    translate(DCFloorOffset1)
        placeInRack(40,StandardRackUnitWidth,1*StandardRackUnitHeight,RackUnitDepth/10,RackUnitColor,"Cable Guide"); 
    translate(DCFloorOffset1)
        placeInRack(41,StandardRackUnitWidth,3*StandardRackUnitHeight,RackUnitDepth/5,RackUnitColor,"Copper Panel"); 
        translate(DCFloorOffset2)
        placeInRack(30,StandardRackUnitWidth,622,RackUnitDepth/1.1,RackUnitColorRed,"Nexus 7010");
...
//power("Power Rail A",FloatLabelColorTitle,LabelT,0,2*600+500,2790,20*600);
//lighting("Lighting Row A",FloatLabelColorTitle,LabelT,0,2*600+500,2560,20*600);
//sprinkler("Sprinkler Row A",FloatLabelColorTitle,LabelT,0,2*600+400,2860,20*600);
//color([1,0,0],0.2)translate(DCFloorOffset0+[0,800,0])cube([2400,800,2070]);
//color([0,0,1],.2) translate(DCFloorOffset0-[0,800,0])cube([2400,800,2070]);
...
$vpt = [1207, 248.78, 1090];
$vpr = [$t*5-290, 0, $t*50-30];
$vpd = 9000;
...
//Applications/OpenSCAD.app/Contents/MacOS/OpenSCAD --render -o Figure-source-NDC-example.stl Figure-source-NDC-example.scad
//Applications/OpenSCAD.app/Contents/MacOS/OpenSCAD -o Figure-source-NDC-example.png --colorscheme=Tomorrow --imgsize=1220,1080 --camera=1617,284,1432,81,0,351.5,9000  Figure-source-NDC-example.scad
